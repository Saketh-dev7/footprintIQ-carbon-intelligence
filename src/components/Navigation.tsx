...
export function Navigation() {
  ...
  return (
    ...
    >
      <Link 
        href="/" 
        aria-label="FootprintIQ Home" 
        className="hidden md:flex items-center gap-2 group outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg p-1"
      >
      ...
      <div className="flex items-center gap-6 md:gap-8" role="menubar">
        {navItems.map((item) => {
